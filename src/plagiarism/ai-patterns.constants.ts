export const AI_PATTERNS = {
  PROBLEM_ID_MAP: {
    ...
    'group-anagrams': '8',
    'groupanagrams': '8',
    // Numeric string IDs (if your DB uses them)
    '1': '1',
    '2': '2',
    '3': '3',
    '7': '7',
  ...
  // Minimum reasonable time in seconds to solve the problem naturally.
  // Simple problems like "Reverse String" have very low thresholds.
  MIN_TIME_S: {
    '1': 45, // Two Sum
    '2': 8,  // Reverse String (e.g. return s[::-1] is very fast)
    '3': 20, // FizzBuzz
    '7': 90, // Longest Substring
    '8': 90, // Group Anagrams
    'DEFAULT': 45,
