...
let ReportsController = class ReportsController {
    constructor(reportsService, analysisService) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ReportsController.prototype, "getByInterview", null);
__decorate([
    (0, common_1.Get)('candidate/:id/insights'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ReportsController.prototype, "getCandidateInsights", null);
exports.ReportsController = ReportsController = __decorate([
    (0, common_1.Controller)('reports'),
    __metadata("design:paramtypes", [reports_service_1.ReportsService,
        candidate_analysis_service_1.CandidateAnalysisService])
], ReportsController);
